...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    clean_ingredient = set()
    for item in dish_ingredients:
        if item not in clean_ingredient:
            clean_ingredient.add(item)
    return dish_name, clean_ingredient
...
def compile_ingredients(dishes):
    ...
    list_of_all_ingredients = set()
    for dish in dishes:
        list_of_all_ingredients = list_of_all_ingredients | dish
    return list_of_all_ingredients
